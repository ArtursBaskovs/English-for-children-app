...
public class Task4Act extends AppCompatActivity {
    Button atb, toMain;
    TextView tquest;
    EditText taskInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String question = dbMan.fetchQuestions(6);
        String answ = dbMan.fetchAnswers(6);
        ...
        atb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answ.equals(taskInput.getText().toString())) {
                    ...
                    Intent i1 = new Intent(Task4Act.this, EndAct.class);
                    startActivity(i1);
        ...
        toMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1 = new Intent(Task4Act.this, MainActivity.class);
                startActivity(i1);
            }
        });
    }
