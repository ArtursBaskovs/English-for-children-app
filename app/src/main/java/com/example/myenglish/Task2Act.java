...
public class Task2Act extends AppCompatActivity {
    Button atb, toMain;
    TextView tquest;
    EditText taskInput;
...
//db
        ...
        String answ = dbMan.fetchAnswers(3);
        ...
        atb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answ.equals(taskInput.getText().toString())) {
                    ...
                    Intent i1 = new Intent(Task2Act.this, Task3Act.class);
                    startActivity(i1);
        ...
        toMain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i1 = new Intent(Task2Act.this, MainActivity.class);
                startActivity(i1);
            }
        });
